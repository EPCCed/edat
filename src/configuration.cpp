...
std::string Configuration::envKeys[] = { "EDAT_NUM_THREADS", "EDAT_MAIN_THREAD_WORKER", "EDAT_REPORT_THREAD_MAPPING", "EDAT_PROGRESS_THREAD", "EDAT_RESILIENCE", "EDAT_BEAT_PERIOD" };
